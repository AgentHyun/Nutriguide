...
import QuestionPage from './frontend/components/QuestionPage'
import AddMenuPage from './frontend/components/AddMenuPage';
function App() {
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/input/inputMenu" element={<InputMenuPage setServerResponse={setServerResponse} />} />
        <Route
          path="/product"
          element={<ProductPage serverResponse={serverResponse} />}
        />
        ...
        <Route
          path="/detail"
          element={<DetailPage nutrition={nutrition} />}
        />
